...
int main() {
    ...
    for (int i = 0; i < sizeof(studentCount) / sizeof(studentCount[0]); i++) {
        ...
        std::cout << "Failo sukuriamas per " << elapsed.count() << " sekundes." << std::endl;
        ...
        elapsed = end - start;
        std::cout << "Studentai surusiuojami per " << elapsed.count() << " sekundes." << std::endl;
        ...
        elapsed = end - start;
        std::cout << "Surusiuoti studentai isvedami per " << elapsed.count() << " sekundes." << std::endl;
    }
